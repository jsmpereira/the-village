...
public class StaticObserver extends Observer {

	public StaticObserver(Point3D location, Point3D lookAt) {
		super(location, lookAt);
		// TODO Auto-generated constructor stub
	}
	
	public StaticObserver(Point3D location, Vector3D heading) {
